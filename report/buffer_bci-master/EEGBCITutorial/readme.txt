This directory contains the source code and instructions for the : "Introduction to EEG BCI tutorial".  This tutorial teach you:
...
3) How the brain responses to different stimuli, e.g. visual, auditory, look and give you some feeling for the relative strength of the response
